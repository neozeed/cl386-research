 ...
 */
//static inline 
unsigned type_hash (struct type *t)
{
...
/* old version */
//static inline 
const char *nextcolon(const char *pszString)
{
...
#endif
          no_warning ("Unknown range type: unknown no long long");
          goto syntax;
        }
      break;
      ...
      switch (*parse_ptr)
        ...
        case 'f':
          ...
          /* Start another block for the local variables. This is to work
             ...
             C++ bool type.  */
            addr = proc_start_addr + prologue_length;
