...
#if 0
old cl386 doesnt like this at all -E it from a new one.
	  fflush (symfile);
	  fseek (symfile,
		 ...
		 0);
#else
	//this didnt compile with Version 6.00.081
	//so I parsed it with version 8 and just pasted it in
	//using 'where to got' to find the code
